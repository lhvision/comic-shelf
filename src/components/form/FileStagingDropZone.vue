...
const props = withDefaults(
  ...
  }>(),
  {
    ...
    prompt: '点击选择画页，或将图片/PDF批量拖拽到此处',
    hint: '支持 JPG, PNG, WebP, GIF, AVIF 及 PDF 漫画（无损抽取与智能分话）',
    pathPlaceholder: '如：/app/data/comics/tiya 或 /storage/manga.pdf',
    pathLabel: '服务器本地目录或单文件 PDF 路径',
    showTabs: true,
  },
)
